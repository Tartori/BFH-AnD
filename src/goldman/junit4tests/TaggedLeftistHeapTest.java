...
import goldman.collection.tagged.priority.TaggedLeftistHeap;

public class TaggedLeftistHeapTest extends TaggedPriorityQueueTest {

	@Override
	public TaggedCollection<Integer, String> createCollection() {
		return new TaggedLeftistHeap<Integer, String>();
	}
